...
public class InformationT extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Skilled Course 2 :");
        jPanel5.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, -1, 20));
        jPanel5.add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 140, 230, -1));
        ...
        jPanel5.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 360, 90, 20));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel20.setText("User Name :");
        jPanel5.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 60, -1, 20));
        jPanel5.add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 60, 230, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setText("Skilled Course 1 :");
        jPanel5.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 100, -1, 20));
        jPanel5.add(jTextField16, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 100, 230, -1));
 ...
 public void cachV(String n,String u,String p,String cst)
    {
        String line;
        deg = cst;
            ...
            while((line = br.readLine())!=null)
            {
                ...
                while(t.hasMoreTokens())
                {
                    if(n.equals(t.nextToken())&&u.equals(t.nextToken())&&p.equals(t.nextToken()))
                    {
                        ...
                        jTextField16.setText(t.nextToken());
                        jTextField9.setText(t.nextToken());
 ...
 private void checkP()
    {
        ...
        String newfn = jTextField8.getText();
            String newonline = jTextField10.getText();
  ...
  private void checkT()
    {
        String newfn = jTextField8.getText();
            ...
            String c1 = jTextField16.getText();
            String c2 = jTextField9.getText();
